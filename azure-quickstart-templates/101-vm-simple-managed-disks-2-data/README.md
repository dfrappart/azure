# Exemple de déploiement d'une simple VM Windows Server avec deux disques supplémentaires (au choix S4, S4, S10, S20 et S30) en "Managed Disk" (initialisés et formatés sous Windows)
